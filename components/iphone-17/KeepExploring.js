...
import KeepExploringIcon11 from "@/public/assets/iphone-17-keep-exploring-icon-1-1.svg";
import KeepExploringIcon12 from "@/public/assets/iphone-17-keep-exploring-icon-1-2.svg";
import KeepExploringIcon13 from "@/public/assets/iphone-17-keep-exploring-icon-1-3.svg";
import KeepExploringIcon14 from "@/public/assets/iphone-17-keep-exploring-icon-1-4.svg";
import KeepExploringIcon21 from "@/public/assets/iphone-17-keep-exploring-icon-2-1.svg";
import KeepExploringIcon22 from "@/public/assets/iphone-17-keep-exploring-icon-2-2.svg";
import KeepExploringImagePng1 from "@/public/assets/iphone-17-keep-exploring-img-1-png.png";
import KeepExploringImagePng2 from "@/public/assets/iphone-17-keep-exploring-img-2-png.png";
      ...
      <div className="bg-[#F5F5F7] lg:bg-white w-full rounded-3xl mt-5 md:mt-10 px-4 pb-5 md:pb-10 lg:pb-30">
        <div className="flex flex-row justify-between md:justify-center items-start gap-4 md:gap-10">
          ...
          <div className="py-5 md:py-10 flex flex-col gap-4 items-start text-left md:items-center md:text-center max-w-[500px]">
            <CommonImage
              src={KeepExploringImagePng2.src || KeepExploringImagePng2}
            ...
            <div className="flex flex-col gap-4 items-start md:items-center text-xs font-normal tracking-[-0.12px]">
              ...
              <div className="flex flex-col gap-2 items-start md:items-center">
                <CommonImage
                  height={56}
                  width={46}
                  src={KeepExploringIcon11.src || KeepExploringIcon11}
                  alt="icon-1.1"
                />
              ...
              <div className="flex flex-col gap-2 items-start md:items-center">
                <CommonImage
                  height={56}
                  width={36}
                  src={KeepExploringIcon12.src || KeepExploringIcon12}
                  alt="icon-1.2"
                />
                <p>A19 Chip</p>
              ...
              <div className="flex flex-col gap-2 items-start md:items-center">
                <CommonImage
                  height={56}
                  width={46}
                  src={KeepExploringIcon13.src || KeepExploringIcon13}
                  alt="icon-1.3"
                />
              ...
              <div className="flex flex-col gap-2 items-start md:items-center">
                <CommonImage
                  height={56}
                  width={42}
                  src={KeepExploringIcon14.src || KeepExploringIcon14}
                  alt="icon-1.4"
                />
          ...
          <div className="py-5 md:py-10 flex flex-col gap-4 items-start text-left md:items-center md:text-center max-w-[500px]">
            <CommonImage
              src={KeepExploringImagePng1.src || KeepExploringImagePng1}
              className="h-auto w-auto"
            />
            <p className="text-primary text-lg md:text-xl lg:text-2xl font-bold tracking-[0.2px]">
              iPhone 17 Air
            ...
            <div className="flex flex-col gap-4 items-start md:items-center text-xs font-normal tracking-[-0.12px]">
              ...
              <div className="flex flex-col gap-2 items-start md:items-center">
                <CommonImage
                  height={56}
                  width={46}
                  src={KeepExploringIcon21.src || KeepExploringIcon21}
                  alt="icon-2.1"
                />
              ...
              <div className="flex flex-col gap-2 items-start md:items-center">
                <CommonImage
                  height={56}
                  width={36}
                  src={KeepExploringIcon22.src || KeepExploringIcon22}
                  alt="icon-2.2"
                />
                <p>A19 Pro Chip</p>
                <p>5-core GPU with Neural Accelarators</p>
